...
const cardData: BentoCardProps[] = [
  ...
  },
  {
    color: '#060010',
    title: 'Architecture',
    description: 'Define data flow, stack choices, and folder structure for long-term maintainability.',
    label: 'Planning'
  },
  {
    color: '#060010',
    title: 'UI Systems',
    description: 'Translate layouts into reusable, responsive components.',
    label: 'Design to Code'
  },
  {
    color: '#060010',
    title: 'Performance',
    description: 'Measure, profile, and remove bottlenecks early.',
    label: 'Optimization'
  },
  {
    color: '#060010',
    title: 'Quality',
    description: 'Manual and automated checks for stability and edge cases.',
    label: 'Testing'
  },
  {
    color: '#060010',
    title: 'Delivery',
    description: 'Ship, collect feedback, and refine continuously.',
    label: 'Iteration'
  }
];
